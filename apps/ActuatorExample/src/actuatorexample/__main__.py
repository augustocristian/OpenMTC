...
from .actuator_example import ActuatorExample

# defaults
default_name = "ActuatorExample"
default_ep = "http://localhost:8000"

# args parser
parser = ArgumentParser(
    description="An IPE called ActuatorExample",
    prog="ActuatorExample",
...
poas = config.get("poas", ["http://auto:26074"])
